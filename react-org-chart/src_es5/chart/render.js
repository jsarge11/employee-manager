...
var onClick = require('./on-click');
var iconLink = require('./components/icon-link');
...
function render(config) {
  var svgroot = config.svgroot,
      ...
      onPersonLinkClick = config.onPersonLinkClick;
  ...
  var parentNode = sourceNode || treeData;

  // Enter any new nodes at the parent's previous position.
  var nodeEnter = node.enter().insert('g').attr('class', CHART_NODE_CLASS).attr('transform', 'translate(' + parentNode.x0 + ', ' + parentNode.y0 + ')').on('click', onClick(config));
