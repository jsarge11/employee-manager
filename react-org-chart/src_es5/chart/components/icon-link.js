...
module.exports = function iconLink(_ref) {
  var svg = _ref.svg,
      _ref$x = _ref.x,
      x = _ref$x === undefined ? 5 : _ref$x,
      _ref$y = _ref.y,
      y = _ref$y === undefined ? 5 : _ref$y;

  var container = svg.append('g').attr('stroke', 'none').attr('fill', 'none').style('cursor', 'pointer').append('g');

  var icon = container.append('g').attr('id', 'icon').attr('fill', '#92a0ad').attr('transform', 'translate(' + x + ', ' + y + ')');

  var arrow = icon.append('g').attr('id', 'arrow').attr('transform', 'translate(7.000000, 7.000000) scale(-1, 1) translate(-7.000000, -7.000000)');
